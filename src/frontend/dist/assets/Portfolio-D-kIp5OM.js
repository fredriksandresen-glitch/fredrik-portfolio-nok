import { c as createLucideIcon, r as reactExports, R as React, j as jsxRuntimeExports, v as vt, i as cn, o, k as reactDomExports, b as usePortfolioStore, l as useActor, S as StatusBadge, d as formatNOK, m as TableRowSkeleton, A as AssetType, n as formatQty, f as formatPercent, p as createActor } from "./index-BeUVb1Bc.js";
import { u as useLayoutEffect2, P as Primitive, c as composeEventHandlers, d as dispatchDiscreteCustomEvent, a as useControllableState, b as createContext2, e as createContextScope, f as createSlot, g as createSlottable, h as useSize, i as usePrevious, L as Label } from "./index-DwFEGl36.js";
import { u as useComposedRefs, b as buttonVariants, B as Button, a as Badge } from "./button-D-MqWtTN.js";
...
function SortIcon({ active, dir }) {
  if (!active)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { className: "ml-1 h-3 w-3 opacity-40 shrink-0" });
  return dir === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "ml-1 h-3 w-3 shrink-0 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "ml-1 h-3 w-3 shrink-0 text-accent" });
}
function EditModal({ holding, open, onClose, onSave }) {
  var _a, _b;
  const {
    register,
    control,
    ...
    defaultValues: {
      mode: "exact",
      amount: ((_a = holding == null ? void 0 : holding.quantity) == null ? void 0 : _a.toString()) ?? "0",
      stakedQty: ((_b = holding == null ? void 0 : holding.stakedQty) == null ? void 0 : _b.toString()) ?? "0"
    }
  });
    ...
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "font-display", children: [
          "Rediger ",
          holding.name,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 font-mono text-sm text-muted-foreground", children: holding.symbol })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-4 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-mode", children: "Operasjon" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Controller,
              {
                control,
                ...
                render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: field.value, onValueChange: field.onChange, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ["buy", "sell", "exact"].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: m, children: modeLabel[m] }, m)) })
                ] })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-amount", children: mode === "exact" ? "Nytt antall" : mode === "buy" ? "Kjøp antall" : "Selg antall" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "edit-amount",
            ...
            errors.amount && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.amount.message }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Nåværende:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: formatQty(holding.quantity, holding.symbol) })
            ] })
          ] }),
          holding.assetType === AssetType.Crypto && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-staked", children: "Staked antall" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "edit-staked",
            ...
            errors.stakedQty && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.stakedQty.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "pt-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isSubmitting ? "Lagrer..." : "Lagre"
              }
            )
          ] })
        ] })
    ...
    Dialog,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        DialogContent,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: "Legg til nytt aktiva" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-4 pt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-symbol", children: "Symbol" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "add-symbol",
                  ...
                  errors.symbol && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.symbol.message })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-type", children: "Type" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Controller,
                    {
                      control,
                        ...
                        Select,
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: AssetType.Stock, children: "Aksje" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: AssetType.Crypto, children: "Krypto" })
                            ] })
                          ]
                        }
                      )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-name", children: "Navn" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "add-name",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-qty", children: "Antall" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "add-qty",
                  ...
                  errors.quantity && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.quantity.message })
                ] }),
                assetType === AssetType.Crypto && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-staked", children: "Staked" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "add-staked",
              ...
              assetType === AssetType.Crypto && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-yield", children: "Avkastning (% per år)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "add-yield",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "pt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: isSubmitting ? "Legger til..." : "Legg til"
                  }
                )
              ] })
            ] })
...
function Portfolio() {
  ...
  const [sortKey, setSortKey] = reactExports.useState("valueNOK");
  ...
  const totalValue = (summary == null ? void 0 : summary.totalValueNOK) ?? 0;
  ...
  const sortedAssets = [...assets].sort((a, b) => {
    ...
    switch (sortKey) {
      ...
      case "allocation":
        return mul * (a.valueNOK - b.valueNOK);
      case "price":
        return mul * ((((_a2 = a.price) == null ? void 0 : _a2.priceNOK) ?? 0) - (((_b = b.price) == null ? void 0 : _b.priceNOK) ?? 0));
      case "dailyChange":
        return mul * ((((_c = a.price) == null ? void 0 : _c.priceUSD) ?? 0) - (((_d = b.price) == null ? void 0 : _d.priceUSD) ?? 0));
      default:
        return 0;
    }
  });
  const refreshSummary = reactExports.useCallback(async () => {
    if (!actor) return;
    try {
      const updated = await actor.getPortfolioSummary();
      setSummary(updated);
    } catch {
      ue.error("Kunne ikke oppdatere portefølje");
    }
  }, [actor, setSummary]);
  const handleEdit = async (updated) => {
    if (!actor) return;
    await actor.updateAsset(updated);
    ue.success(`${updated.name} oppdatert`);
    setEditTarget(null);
  ...
  const handleAdd = async (holding) => {
    ...
    ue.success(`${holding.name} lagt til`);
    setShowAdd(false);
    await refreshSummary();
  };
  const confirmDelete = async () => {
    ...
    try {
      ...
      ue.success(`${deleteTarget.name} slettet`);
      setDeleteTarget(null);
      await refreshSummary();
    } catch {
      ue.error("Sletting mislyktes");
    } finally {
      setIsDeleting(false);
    }
  };
      ...
      "th",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              label,
              /* @__PURE__ */ jsxRuntimeExports.jsx(SortIcon, { active: sortKey === col, dir: sortDir })
            ]
          }
        )
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "portfolio-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold text-foreground", children: "Portefølje" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Oversikt over alle beholdninger" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(PackagePlus, { className: "h-4 w-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Legg til" })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: [
      ...
      { label: "USD/NOK", value: ((_a = summary == null ? void 0 : summary.usdNokRate) == null ? void 0 : _a.toFixed(2)) ?? "—" }
    ].map(({ label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-lg border border-border bg-card px-3 py-2.5 sm:px-4",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground font-mono uppercase tracking-wider", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base sm:text-lg font-bold text-foreground mt-0.5 truncate", children: value })
        ]
      },
      label
    )) }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2.5 border-b border-border flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Beholdninger" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-mono", children: [
              sortedAssets.length,
              " aktiva"
            ] })
          ] }),
          isLoading && assets.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRowSkeleton, { rows: 5 }) }) : assets.length === 0 ? (
            /* Empty state */
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(PackagePlus, { className: "h-10 w-10 opacity-30" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Ingen aktiva funnet" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", children: "Kom i gang ved å legge til ditt første aktiva" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "sm",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:block overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "border-b border-border bg-muted/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { col: "name", label: "Aktiva", className: "pl-4 w-[220px]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { col: "quantity", label: "Beholdning" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { col: "price", label: "Pris" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { col: "valueNOK", label: "Verdi (NOK)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { col: "allocation", label: "Andel" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2.5 text-right text-xs font-mono font-medium uppercase tracking-wider text-muted-foreground pr-4", children: "Handlinger" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: sortedAssets.map(({ holding, price, valueNOK }) => {
                const allocation = totalValue > 0 ? valueNOK / totalValue * 100 : 0;
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "tr",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "pl-4 pr-3 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-accent/10 border border-accent/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] font-bold text-accent", children: holding.symbol.slice(0, 3) }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground truncate", children: holding.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-0.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-muted-foreground", children: holding.symbol }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Badge,
                              {
                                variant: "outline",
                                className: "text-[9px] px-1 py-0 h-4 font-mono",
                                children: isCrypto ? "Krypto" : "Aksje"
                              }
                            )
                          ] })
                        ] })
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-sm text-foreground", children: formatQty(holding.quantity, holding.symbol) }),
                        holding.stakedQty > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-xs text-accent mt-0.5", children: [
                          formatQty(holding.stakedQty, holding.symbol),
                          " ",
                          "staked"
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3", children: price ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-sm text-foreground", children: price.priceNOK >= 1 ? formatNOK(price.priceNOK) : `${price.priceNOK.toFixed(4)} NOK` }),
                        price.priceUSD > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-xs text-muted-foreground mt-0.5", children: [
                          "$",
                          price.priceUSD >= 1 ? price.priceUSD.toFixed(2) : price.priceUSD.toFixed(4)
                        ] })
                      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs font-mono", children: "—" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono font-semibold text-foreground", children: formatNOK(valueNOK) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-[80px]", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-muted-foreground w-10 text-right", children: formatPercent(allocation, false) })
                      ] }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 pr-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Button,
                          {
                            size: "icon",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sm:hidden divide-y divide-border", children: sortedAssets.map(({ holding, valueNOK }) => {
              const allocation = totalValue > 0 ? valueNOK / totalValue * 100 : 0;
              const isCrypto = holding.assetType === AssetType.Crypto;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  "data-ocid": `portfolio-row-${holding.symbol.toLowerCase()}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-accent/10 border border-accent/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] font-bold text-accent", children: holding.symbol.slice(0, 3) }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: holding.name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-[9px] px-1 py-px rounded font-mono bg-muted/40 text-muted-foreground", children: isCrypto ? "Krypto" : "Aksje" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-mono mt-0.5", children: [
                        ...
                        holding.stakedQty > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-accent", children: [
                          "(",
                          formatQty(holding.stakedQty, holding.symbol),
                          " ",
                          "staked)"
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold font-mono text-foreground", children: formatNOK(valueNOK) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: formatPercent(allocation, false) })
                    ] }),
          ...
          AlertDialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display", children: "Slett aktiva" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
                  "Er du sikker på at du vil slette",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: deleteTarget == null ? void 0 : deleteTarget.name }),
                  " ",
                  "(",
                  deleteTarget == null ? void 0 : deleteTarget.symbol,
                  ") fra porteføljen? Denne handlingen kan ikke angres."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AlertDialogAction,
                  {
                    ...
                    children: isDeleting ? "Sletter..." : "Slett"
                  }
                )
              ] })
            ]
